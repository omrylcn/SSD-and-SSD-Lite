...
from data_generator.object_detection_2d_geometric_ops import RandomFlip, RandomTranslate, RandomScale,ResizeRandomInterp
...
class DataAugmentation:
    ...
    def __init__(self,
        ...
        self.random_zoom_out = RandomScale(min_factor=random_scale[0],
                                           ...
                                           labels_format=self.labels_format)
        if self.size:
             self.resize = ResizeRandomInterp(height=self.h,
                                         width=self.w,
        ...
        self.sequence3 = [self.resize] # for val dataset
